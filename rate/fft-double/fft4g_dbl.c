...
static void bitrv2 (int n, double *a, int const *ip);
static void cftfsub(int n, double *a, double const *w);
static void cftbsub(int n, double *a, double const *w);
static void rftfsub(int n, double *a, double const *c);
static void rftbsub(int n, double *a, double const *c);
...
{
    lsx_aligned_free(z->ip);
    lsx_aligned_free(z->wt);
    lsx_aligned_free(z->ct);
    z->ip = NULL;
    z->wt = NULL;
    z->ct = NULL;
    z->n = 0;
